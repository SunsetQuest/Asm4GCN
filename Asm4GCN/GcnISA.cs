...
new InstInfo(0058, "ds_add_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[A] + DS[B]; uint add.", @"", ISA_Enc.DS, 128, 0, 0xDA000000, 0x0003),
new InstInfo(0059, "ds_add_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint add.", @"", ISA_Enc.DS, 192, 0, 0xDB000000, 0x0003),
...
new InstInfo(0066, "ds_and_src2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[A] & DS[B]; Dword AND.", @"", ISA_Enc.DS, 137, 0, 0xDA240000, 0x0003),
new InstInfo(0067, "ds_and_src2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword AND. ", @"", ISA_Enc.DS, 201, 0, 0xDB240000, 0x0003),
...
new InstInfo(0082, "ds_dec_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = (DS[A] == 0 || DS[A] > DS[B] ? DS[B] : DS[A] - 1); uint decrement.", @"", ISA_Enc.DS, 132, 0, 0xDA100000, 0x0003),
new InstInfo(0083, "ds_dec_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint decrement.", @"", ISA_Enc.DS, 196, 0, 0xDB100000, 0x0003),
...
new InstInfo(0094, "ds_inc_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = (DS[A] >= DS[B] ? 0 : DS[A] + 1); uint increment.", @"", ISA_Enc.DS, 131, 0, 0xDA0C0000, 0x0003),
new InstInfo(0095, "ds_inc_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint increment.", @"", ISA_Enc.DS, 195, 0, 0xDB0C0000, 0x0003),
...
new InstInfo(0108, "ds_max_src2_f32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = (DS[B] > DS[A]) ? DS[B] : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS, 147, 0, 0xDA4C0000, 0x0003),
new InstInfo(0109, "ds_max_src2_f64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}).  [A] = (D0 > DS[A]) ? D0 : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS, 211, 0, 0xDB4C0000, 0x0003),
new InstInfo(0110, "ds_max_src2_i32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = max(DS[A], DS[B]); int max.", @"", ISA_Enc.DS, 134, 0, 0xDA180000, 0x0003),
new InstInfo(0111, "ds_max_src2_i64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Int max.", @"", ISA_Enc.DS, 198, 0, 0xDB180000, 0x0003),
new InstInfo(0112, "ds_max_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = max(DS[A], DS[B]); uint maxw", @"", ISA_Enc.DS, 136, 0, 0xDA200000, 0x0003),
new InstInfo(0113, "ds_max_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint max.", @"", ISA_Enc.DS, 200, 0, 0xDB200000, 0x0003),
...
new InstInfo(0116, "ds_min_f32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (DS[A] < D1) ? D0 : DS[A]; float compare swap (handles NaN/INF/denorm).", @"", ISA_Enc.DS, 18, 0, 0xD8480000, 0x0003),
...
new InstInfo(0126, "ds_min_src2_f32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = (DS[B] < DS[A]) ? DS[B] : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS, 146, 0, 0xDA480000, 0x0003),
new InstInfo(0127, "ds_min_src2_f64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}).  [A] = (D0 < DS[A]) ? D0 : DS[A]; float, handles NaN/INF/denorm. ", @"", ISA_Enc.DS, 210, 0, 0xDB480000, 0x0003),
new InstInfo(0128, "ds_min_src2_i32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = min(DS[A], DS[B]); int min.", @"", ISA_Enc.DS, 133, 0, 0xDA140000, 0x0003),
new InstInfo(0129, "ds_min_src2_i64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Int min.", @"", ISA_Enc.DS, 197, 0, 0xDB140000, 0x0003),
new InstInfo(0130, "ds_min_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = min(DS[A], DS[B]); uint min.", @"", ISA_Enc.DS, 135, 0, 0xDA1C0000, 0x0003),
new InstInfo(0131, "ds_min_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint min.", @"", ISA_Enc.DS, 199, 0, 0xDB1C0000, 0x0003),
...
new InstInfo(0143, "ds_or_src2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[A] | DS[B]; Dword OR.", @"", ISA_Enc.DS, 138, 0, 0xDA280000, 0x0003),
new InstInfo(0144, "ds_or_src2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword OR.", @"", ISA_Enc.DS, 202, 0, 0xDB280000, 0x0003),
...
new InstInfo(0154, "ds_read2_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = DS[ADDR+offset0*4], R+1 = DS[ADDR+offset1*4]. Read 2 Dwords.", @"", ISA_Enc.DS, 55, 0, 0xD8DC0000, 0x0003),
new InstInfo(0155, "ds_read2_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = DS[ADDR+offset0*8], R+1 = DS[ADDR+offset1*8]. Read 2 Dwords", @"", ISA_Enc.DS, 119, 0, 0xD9DC0000, 0x0003),
new InstInfo(0156, "ds_read2st64_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = DS[ADDR+offset0*4*64], R+1 = DS[ADDR+offset1*4*64]. Read 2 Dwords.", @"", ISA_Enc.DS, 56, 0, 0xD8E00000, 0x0003),
new InstInfo(0157, "ds_read2st64_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = DS[ADDR+offset0*8*64], R+1 = DS[ADDR+offset1*8*64]. Read 2 Dwords.", @"", ISA_Enc.DS, 120, 0, 0xD9E00000, 0x0003),
...
new InstInfo(0160, "ds_rsub_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[B] - DS[A]; uint reverse subtract.", @"", ISA_Enc.DS, 130, 0, 0xDA080000, 0x0003),
new InstInfo(0161, "ds_rsub_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint reverse subtract.", @"", ISA_Enc.DS, 194, 0, 0xDB080000, 0x0003),
...
new InstInfo(0166, "ds_sub_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[A] - DS[B]; uint subtract.", @"", ISA_Enc.DS, 129, 0, 0xDA040000, 0x0003),
new InstInfo(0167, "ds_sub_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint subtract.", @"", ISA_Enc.DS, 193, 0, 0xDB040000, 0x0003),
...
new InstInfo(0170, "ds_swizzle_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Swizzles input thread data based on offset mask and returns; note does not read or write the DS memory banks.", @"", ISA_Enc.DS, 53, 0, 0xD8D40000, 0x0003),
...
new InstInfo(0178, "ds_write_src2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[B]; write Dword.", @"", ISA_Enc.DS, 140, 0, 0xDA300000, 0x0003),
new InstInfo(0179, "ds_write_src2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[B]; write Qword.", @"", ISA_Enc.DS, 204, 0, 0xDB300000, 0x0003),
new InstInfo(0180, "ds_write2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[ADDR+offset0*4] = D0; DS[ADDR+offset1*4] = D1; write 2 Dwords.", @"", ISA_Enc.DS, 14, 0, 0xD8380000, 0x0003),
new InstInfo(0181, "ds_write2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[ADDR+offset0*8] = D0; DS[ADDR+offset1*8] = D1; write 2 Dwords.", @"", ISA_Enc.DS, 78, 0, 0xD9380000, 0x0003),
new InstInfo(0182, "ds_write2st64_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[ADDR+offset0*4*64] = D0; DS[ADDR+offset1*4*64] = D1; write 2 Dwords.", @"", ISA_Enc.DS, 15, 0, 0xD83C0000, 0x0003),
new InstInfo(0183, "ds_write2st64_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[ADDR+offset0*8*64] = D0; DS[ADDR+offset1*8*64] = D1; write 2 Dwords.", @"", ISA_Enc.DS, 79, 0, 0xD93C0000, 0x0003),
...
new InstInfo(0186, "ds_wrxchg2_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write exchange 2 separate Dwords.", @"", ISA_Enc.DS, 46, 0, 0xD8B80000, 0x0003),
new InstInfo(0187, "ds_wrxchg2_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write exchange relative.", @"", ISA_Enc.DS, 110, 0, 0xD9B80000, 0x0003),
new InstInfo(0188, "ds_wrxchg2st64_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write exchange 2 Dwords, stride 64.", @"", ISA_Enc.DS, 47, 0, 0xD8BC0000, 0x0003),
new InstInfo(0189, "ds_wrxchg2st64_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write echange 2 Dwords.", @"", ISA_Enc.DS, 111, 0, 0xD9BC0000, 0x0003),
...
new InstInfo(0194, "ds_xor_src2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[A] ^ DS[B]; Dword XOR.", @"", ISA_Enc.DS, 139, 0, 0xDA2C0000, 0x0003),
new InstInfo(0195, "ds_xor_src2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword XOR.", @"", ISA_Enc.DS, 203, 0, 0xDB2C0000, 0x0003),
