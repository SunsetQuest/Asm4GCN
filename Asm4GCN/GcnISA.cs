...
new InstInfo(0178, "ds_write_src2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[B]; write Dword.", @"", ISA_Enc.DS, 141, 0, 0xDA340000, 0x0003),
new InstInfo(0179, "ds_write_src2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[B]; write Qword.", @"", ISA_Enc.DS, 205, 0, 0xDB340000, 0x0003),
