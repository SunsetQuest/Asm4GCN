...
namespace GcnTools
{
    ...
    public enum ISA_Enc
    {
        ...
        VINTRP,
        DS,
        DS2,     // for dual issue DS instructions
        EXP,
        FLAT,
        MUBUF,
        MTBUF,
...
new InstInfo(0056, "ds_add_rtn_u32", "v4u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint add.", @"", ISA_Enc.DS, 32, 0, 0xD8800000, 0x0003),
new InstInfo(0057, "ds_add_rtn_u64", "v8u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint add.", @"", ISA_Enc.DS, 96, 0, 0xD9800000, 0x0003),
new InstInfo(0058, "ds_add_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[A] + DS[B]; uint add.", @"", ISA_Enc.DS2, 128, 0, 0xDA000000, 0x0003),
new InstInfo(0059, "ds_add_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint add.", @"", ISA_Enc.DS2, 192, 0, 0xDB000000, 0x0003),
new InstInfo(0060, "ds_add_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = DS[A] + D0; uint add.", @"", ISA_Enc.DS, 0, 0, 0xD8000000, 0x0003),
new InstInfo(0061, "ds_add_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint add.", @"", ISA_Enc.DS, 64, 0, 0xD9000000, 0x0003),
new InstInfo(0062, "ds_and_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = DS[A] & D0; Dword AND.", @"", ISA_Enc.DS, 9, 0, 0xD8240000, 0x0003),
new InstInfo(0063, "ds_and_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword AND.", @"", ISA_Enc.DS, 73, 0, 0xD9240000, 0x0003),
new InstInfo(0064, "ds_and_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword AND.", @"", ISA_Enc.DS, 41, 0, 0xD8A40000, 0x0003),
new InstInfo(0065, "ds_and_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword AND.", @"", ISA_Enc.DS, 105, 0, 0xD9A40000, 0x0003),
new InstInfo(0066, "ds_and_src2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[A] & DS[B]; Dword AND.", @"", ISA_Enc.DS2, 137, 0, 0xDA240000, 0x0003),
new InstInfo(0067, "ds_and_src2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword AND. ", @"", ISA_Enc.DS2, 201, 0, 0xDB240000, 0x0003),
new InstInfo(0068, "ds_append", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Append one or more entries to a buffer.", @"", ISA_Enc.DS, 62, 0, 0xD8F80000, 0x0003),
new InstInfo(0069, "ds_cmpst_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (DS[A] == D0 ? D1 : DS[A]); compare store.", @"", ISA_Enc.DS, 16, 0, 0xD8400000, 0x0003),
new InstInfo(0070, "ds_cmpst_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Compare store.", @"", ISA_Enc.DS, 80, 0, 0xD9400000, 0x0003),
new InstInfo(0071, "ds_cmpst_f32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (DS[A] == D0 ? D1 : DS[A]); compare store with float rules.", @"", ISA_Enc.DS, 17, 0, 0xD8440000, 0x0003),
new InstInfo(0072, "ds_cmpst_f64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Compare store with float rules.", @"", ISA_Enc.DS, 81, 0, 0xD9440000, 0x0003),
new InstInfo(0073, "ds_cmpst_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Compare store.", @"", ISA_Enc.DS, 48, 0, 0xD8C00000, 0x0003),
new InstInfo(0074, "ds_cmpst_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Compare store.", @"", ISA_Enc.DS, 112, 0, 0xD9C00000, 0x0003),
new InstInfo(0075, "ds_cmpst_rtn_f32", "v4f", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Compare store with float rules.", @"", ISA_Enc.DS, 49, 0, 0xD8C40000, 0x0003),
new InstInfo(0076, "ds_cmpst_rtn_f64", "v8f", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Compare store with float rules.", @"", ISA_Enc.DS, 113, 0, 0xD9C40000, 0x0003),
new InstInfo(0077, "ds_condxchg32_rtn_b128", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Conditional write exchange.", @"", ISA_Enc.DS, 253, 0, 0xDBF40000, 0x0003),
new InstInfo(0078, "ds_condxchg32_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Conditional write exchange. ", @"", ISA_Enc.DS, 126, 0, 0xD9F80000, 0x0003),
new InstInfo(0079, "ds_consume", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Consume entries from a buffer.", @"", ISA_Enc.DS, 61, 0, 0xD8F40000, 0x0003),
new InstInfo(0080, "ds_dec_rtn_u32", "v4u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint decrement.", @"", ISA_Enc.DS, 36, 0, 0xD8900000, 0x0003),
new InstInfo(0081, "ds_dec_rtn_u64", "v8u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint decrement.", @"", ISA_Enc.DS, 100, 0, 0xD9900000, 0x0003),
new InstInfo(0082, "ds_dec_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = (DS[A] == 0 || DS[A] > DS[B] ? DS[B] : DS[A] - 1); uint decrement.", @"", ISA_Enc.DS2, 132, 0, 0xDA100000, 0x0003),
new InstInfo(0083, "ds_dec_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint decrement.", @"", ISA_Enc.DS2, 196, 0, 0xDB100000, 0x0003),
new InstInfo(0084, "ds_dec_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (DS[A] == 0 || DS[A] > D0 ? D0 : DS[A] - 1); uint decrement.", @"", ISA_Enc.DS, 4, 0, 0xD8100000, 0x0003),
new InstInfo(0085, "ds_dec_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint decrement.", @"", ISA_Enc.DS, 68, 0, 0xD9100000, 0x0003),
new InstInfo(0086, "ds_gws_barrier", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"GDS only.", @"", ISA_Enc.DS, 29, 0, 0xD8740000, 0x0003),
new InstInfo(0087, "ds_gws_init", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"GDS only.", @"", ISA_Enc.DS, 25, 0, 0xD8640000, 0x0003),
new InstInfo(0088, "ds_gws_sema_br", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"GDS only.", @"", ISA_Enc.DS, 27, 0, 0xD86C0000, 0x0003),
new InstInfo(0089, "ds_gws_sema_p", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"GDS only.", @"", ISA_Enc.DS, 28, 0, 0xD8700000, 0x0003),
new InstInfo(0090, "ds_gws_sema_release_all", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"GDS Only. Release all wavefronts waiting on this semaphore. ResourceID is in offset[4:0].", @"", ISA_Enc.DS, 24, 0, 0xD8600000, 0x0003),
new InstInfo(0091, "ds_gws_sema_v", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"GDS only.", @"", ISA_Enc.DS, 26, 0, 0xD8680000, 0x0003),
new InstInfo(0092, "ds_inc_rtn_u32", "v4u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint increment.", @"", ISA_Enc.DS, 35, 0, 0xD88C0000, 0x0003),
new InstInfo(0093, "ds_inc_rtn_u64", "v8u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint increment.", @"", ISA_Enc.DS, 99, 0, 0xD98C0000, 0x0003),
new InstInfo(0094, "ds_inc_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = (DS[A] >= DS[B] ? 0 : DS[A] + 1); uint increment.", @"", ISA_Enc.DS2, 131, 0, 0xDA0C0000, 0x0003),
new InstInfo(0095, "ds_inc_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint increment.", @"", ISA_Enc.DS2, 195, 0, 0xDB0C0000, 0x0003),
new InstInfo(0096, "ds_inc_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (DS[A] >= D0 ? 0 : DS[A] + 1); uint increment.", @"", ISA_Enc.DS, 3, 0, 0xD80C0000, 0x0003),
new InstInfo(0097, "ds_inc_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint increment.", @"", ISA_Enc.DS, 67, 0, 0xD90C0000, 0x0003),
new InstInfo(0098, "ds_max_f32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (D0 > DS[A]) ? D0 : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS, 19, 0, 0xD84C0000, 0x0003),
new InstInfo(0099, "ds_max_f64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (D0 > DS[A]) ? D0 : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS, 83, 0, 0xD94C0000, 0x0003),
new InstInfo(0100, "ds_max_i32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = max(DS[A], D0); int max.", @"", ISA_Enc.DS, 6, 0, 0xD8180000, 0x0003),
new InstInfo(0101, "ds_max_i64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Int max.", @"", ISA_Enc.DS, 70, 0, 0xD9180000, 0x0003),
new InstInfo(0102, "ds_max_rtn_f32", "v4f", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (D0 > DS[A]) ? D0 : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS, 51, 0, 0xD8CC0000, 0x0003),
new InstInfo(0103, "ds_max_rtn_f64", "v8f", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (D0 > DS[A]) ? D0 : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS, 115, 0, 0xD9CC0000, 0x0003),
new InstInfo(0104, "ds_max_rtn_i32", "v4i", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Int max.", @"", ISA_Enc.DS, 38, 0, 0xD8980000, 0x0003),
new InstInfo(0105, "ds_max_rtn_i64", "v8i", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Int max.", @"", ISA_Enc.DS, 102, 0, 0xD9980000, 0x0003),
new InstInfo(0106, "ds_max_rtn_u32", "v4u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint max.", @"", ISA_Enc.DS, 40, 0, 0xD8A00000, 0x0003),
new InstInfo(0107, "ds_max_rtn_u64", "v8u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint max.", @"", ISA_Enc.DS, 104, 0, 0xD9A00000, 0x0003),
new InstInfo(0108, "ds_max_src2_f32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = (DS[B] > DS[A]) ? DS[B] : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS2, 147, 0, 0xDA4C0000, 0x0003),
new InstInfo(0109, "ds_max_src2_f64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}).  [A] = (D0 > DS[A]) ? D0 : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS2, 211, 0, 0xDB4C0000, 0x0003),
new InstInfo(0110, "ds_max_src2_i32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = max(DS[A], DS[B]); int max.", @"", ISA_Enc.DS2, 134, 0, 0xDA180000, 0x0003),
new InstInfo(0111, "ds_max_src2_i64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Int max.", @"", ISA_Enc.DS2, 198, 0, 0xDB180000, 0x0003),
new InstInfo(0112, "ds_max_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = max(DS[A], DS[B]); uint maxw", @"", ISA_Enc.DS2, 136, 0, 0xDA200000, 0x0003),
new InstInfo(0113, "ds_max_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint max.", @"", ISA_Enc.DS2, 200, 0, 0xDB200000, 0x0003),
new InstInfo(0114, "ds_max_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = max(DS[A], D0); uint max.", @"", ISA_Enc.DS, 8, 0, 0xD8200000, 0x0003),
new InstInfo(0115, "ds_max_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint max.", @"", ISA_Enc.DS, 72, 0, 0xD9200000, 0x0003),
new InstInfo(0116, "ds_min_f32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (DS[A] < D1) ? D0 : DS[A];  compare swap float (handles NaN/INF/denorm).", @"", ISA_Enc.DS, 18, 0, 0xD8480000, 0x0003),
new InstInfo(0117, "ds_min_f64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (D0 < DS[A]) ? D0 : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS, 82, 0, 0xD9480000, 0x0003),
new InstInfo(0118, "ds_min_i32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = min(DS[A], D0); int min.", @"", ISA_Enc.DS, 5, 0, 0xD8140000, 0x0003),
new InstInfo(0119, "ds_min_i64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Int min.", @"", ISA_Enc.DS, 69, 0, 0xD9140000, 0x0003),
new InstInfo(0120, "ds_min_rtn_f32", "v4f", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (DS[A] < D1) ? D0 : DS[A]; float compare swap (handles NaN/INF/denorm).", @"", ISA_Enc.DS, 50, 0, 0xD8C80000, 0x0003),
new InstInfo(0121, "ds_min_rtn_f64", "v8f", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (D0 < DS[A]) ? D0 : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS, 114, 0, 0xD9C80000, 0x0003),
new InstInfo(0122, "ds_min_rtn_i32", "v4i", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Int min.", @"", ISA_Enc.DS, 37, 0, 0xD8940000, 0x0003),
new InstInfo(0123, "ds_min_rtn_i64", "v8i", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Int min.", @"", ISA_Enc.DS, 101, 0, 0xD9940000, 0x0003),
new InstInfo(0124, "ds_min_rtn_u32", "v4u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint min.", @"", ISA_Enc.DS, 39, 0, 0xD89C0000, 0x0003),
new InstInfo(0125, "ds_min_rtn_u64", "v8u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint min.", @"", ISA_Enc.DS, 103, 0, 0xD99C0000, 0x0003),
new InstInfo(0126, "ds_min_src2_f32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = (DS[B] < DS[A]) ? DS[B] : DS[A]; float, handles NaN/INF/denorm.", @"", ISA_Enc.DS2, 146, 0, 0xDA480000, 0x0003),
new InstInfo(0127, "ds_min_src2_f64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}).  [A] = (D0 < DS[A]) ? D0 : DS[A]; float, handles NaN/INF/denorm. ", @"", ISA_Enc.DS2, 210, 0, 0xDB480000, 0x0003),
new InstInfo(0128, "ds_min_src2_i32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = min(DS[A], DS[B]); int min.", @"", ISA_Enc.DS2, 133, 0, 0xDA140000, 0x0003),
new InstInfo(0129, "ds_min_src2_i64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Int min.", @"", ISA_Enc.DS2, 197, 0, 0xDB140000, 0x0003),
new InstInfo(0130, "ds_min_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = min(DS[A], DS[B]); uint min.", @"", ISA_Enc.DS2, 135, 0, 0xDA1C0000, 0x0003),
new InstInfo(0131, "ds_min_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint min.", @"", ISA_Enc.DS2, 199, 0, 0xDB1C0000, 0x0003),
new InstInfo(0132, "ds_min_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = min(DS[A], D0); uint min.", @"", ISA_Enc.DS, 7, 0, 0xD81C0000, 0x0003),
new InstInfo(0133, "ds_min_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint min.", @"", ISA_Enc.DS, 71, 0, 0xD91C0000, 0x0003),
new InstInfo(0134, "ds_mskor_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (DS[A] ^ ~D0) | D1; masked Dword OR.", @"", ISA_Enc.DS, 12, 0, 0xD8300000, 0x0003),
new InstInfo(0135, "ds_mskor_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Masked Dword XOR.", @"", ISA_Enc.DS, 76, 0, 0xD9300000, 0x0003),
new InstInfo(0136, "ds_mskor_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Masked Dword OR.", @"", ISA_Enc.DS, 44, 0, 0xD8B00000, 0x0003),
new InstInfo(0137, "ds_mskor_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Masked Dword XOR.", @"", ISA_Enc.DS, 108, 0, 0xD9B00000, 0x0003),
new InstInfo(0138, "ds_nop", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Do nothing.", @"", ISA_Enc.DS, 20, 0, 0xD8500000, 0x0003),
new InstInfo(0139, "ds_or_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = DS[A] | D0; Dword OR.", @"", ISA_Enc.DS, 10, 0, 0xD8280000, 0x0003),
new InstInfo(0140, "ds_or_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword OR.", @"", ISA_Enc.DS, 74, 0, 0xD9280000, 0x0003),
new InstInfo(0141, "ds_or_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword OR.", @"", ISA_Enc.DS, 42, 0, 0xD8A80000, 0x0003),
new InstInfo(0142, "ds_or_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword OR.", @"", ISA_Enc.DS, 106, 0, 0xD9A80000, 0x0003),
new InstInfo(0143, "ds_or_src2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[A] | DS[B]; Dword OR.", @"", ISA_Enc.DS2, 138, 0, 0xDA280000, 0x0003),
new InstInfo(0144, "ds_or_src2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword OR.", @"", ISA_Enc.DS2, 202, 0, 0xDB280000, 0x0003),
new InstInfo(0145, "ds_ordered_count", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Increment an append counter. The operation is done in wavefront-creation order.", @"", ISA_Enc.DS, 63, 0, 0xD8FC0000, 0x0003),
new InstInfo(0146, "ds_read_b128", "v16b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Qword read.", @"", ISA_Enc.DS, 255, 0, 0xDBFC0000, 0x0003),
new InstInfo(0147, "ds_read_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = DS[A]; Dword read.", @"", ISA_Enc.DS, 54, 0, 0xD8D80000, 0x0003),
new InstInfo(0148, "ds_read_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword read.", @"", ISA_Enc.DS, 118, 0, 0xD9D80000, 0x0003),
new InstInfo(0149, "ds_read_b96", "v12b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Tri-dword read.", @"", ISA_Enc.DS, 254, 0, 0xDBF80000, 0x0003),
new InstInfo(0150, "ds_read_i16", "v4i", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = signext(DS[A][15:0]}; signed short read.", @"", ISA_Enc.DS, 59, 0, 0xD8EC0000, 0x0003),
new InstInfo(0151, "ds_read_i8", "v4i", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = signext(DS[A][7:0]}; signed byte read.", @"", ISA_Enc.DS, 57, 0, 0xD8E40000, 0x0003),
new InstInfo(0152, "ds_read_u16", "v4u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = {16’h0,DS[A][15:0]}; unsigned short read.", @"", ISA_Enc.DS, 60, 0, 0xD8F00000, 0x0003),
new InstInfo(0153, "ds_read_u8", "v4u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = {24’h0,DS[A][7:0]};unsigned byte read.", @"", ISA_Enc.DS, 58, 0, 0xD8E80000, 0x0003),
new InstInfo(0154, "ds_read2_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = DS[ADDR+offset0*4], R+1 = DS[ADDR+offset1*4]. Read 2 Dwords.", @"", ISA_Enc.DS2, 55, 0, 0xD8DC0000, 0x0003),
new InstInfo(0155, "ds_read2_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = DS[ADDR+offset0*8], R+1 = DS[ADDR+offset1*8]. Read 2 Dwords", @"", ISA_Enc.DS2, 119, 0, 0xD9DC0000, 0x0003),
new InstInfo(0156, "ds_read2st64_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = DS[ADDR+offset0*4*64], R+1 = DS[ADDR+offset1*4*64]. Read 2 Dwords.", @"", ISA_Enc.DS2, 56, 0, 0xD8E00000, 0x0003),
new InstInfo(0157, "ds_read2st64_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"R = DS[ADDR+offset0*8*64], R+1 = DS[ADDR+offset1*8*64]. Read 2 Dwords.", @"", ISA_Enc.DS2, 120, 0, 0xD9E00000, 0x0003),
new InstInfo(0158, "ds_rsub_rtn_u32", "v4u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint reverse subtract.", @"", ISA_Enc.DS, 34, 0, 0xD8880000, 0x0003),
new InstInfo(0159, "ds_rsub_rtn_u64", "v8u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint reverse subtract.", @"", ISA_Enc.DS, 98, 0, 0xD9880000, 0x0003),
new InstInfo(0160, "ds_rsub_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[B] - DS[A]; uint reverse subtract.", @"", ISA_Enc.DS2, 130, 0, 0xDA080000, 0x0003),
new InstInfo(0161, "ds_rsub_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint reverse subtract.", @"", ISA_Enc.DS2, 194, 0, 0xDB080000, 0x0003),
new InstInfo(0162, "ds_rsub_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = D0 - DS[A]; uint reverse subtract.", @"", ISA_Enc.DS, 2, 0, 0xD8080000, 0x0003),
new InstInfo(0163, "ds_rsub_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint reverse subtract.", @"", ISA_Enc.DS, 66, 0, 0xD9080000, 0x0003),
new InstInfo(0164, "ds_sub_rtn_u32", "v4u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint subtract.", @"", ISA_Enc.DS, 33, 0, 0xD8840000, 0x0003),
new InstInfo(0165, "ds_sub_rtn_u64", "v8u", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint subtract.", @"", ISA_Enc.DS, 97, 0, 0xD9840000, 0x0003),
new InstInfo(0166, "ds_sub_src2_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[A] - DS[B]; uint subtract.", @"", ISA_Enc.DS2, 129, 0, 0xDA040000, 0x0003),
new InstInfo(0167, "ds_sub_src2_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint subtract.", @"", ISA_Enc.DS2, 193, 0, 0xDB040000, 0x0003),
new InstInfo(0168, "ds_sub_u32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = DS[A] - D0; uint subtract.", @"", ISA_Enc.DS, 1, 0, 0xD8040000, 0x0003),
new InstInfo(0169, "ds_sub_u64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Uint subtract.", @"", ISA_Enc.DS, 65, 0, 0xD9040000, 0x0003),
new InstInfo(0170, "ds_swizzle_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Swizzles input thread data based on offset mask and returns; note does not read or write the DS memory banks.", @"", ISA_Enc.DS2, 53, 0, 0xD8D40000, 0x0003),
new InstInfo(0171, "ds_wrap_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = (DS[A] >= D0) ? DS[A] - D0 : DS[A] + D1.", @"", ISA_Enc.DS, 52, 0, 0xD8D00000, 0x0003),
new InstInfo(0172, "ds_write_b128", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"{DS[A+3], DS[A+2], DS[A+1], DS[A]} = D0[127:0]; qword write.", @"", ISA_Enc.DS, 223, 0, 0xDB7C0000, 0x0003),
new InstInfo(0173, "ds_write_b16", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = D0[15:0]; short write.", @"", ISA_Enc.DS, 31, 0, 0xD87C0000, 0x0003),
new InstInfo(0174, "ds_write_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = D0; write a Dword.", @"", ISA_Enc.DS, 13, 0, 0xD8340000, 0x0003),
new InstInfo(0175, "ds_write_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write.", @"", ISA_Enc.DS, 77, 0, 0xD9340000, 0x0003),
new InstInfo(0176, "ds_write_b8", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = D0[7:0]; byte write.", @"", ISA_Enc.DS, 30, 0, 0xD8780000, 0x0003),
new InstInfo(0177, "ds_write_b96", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"{DS[A+2], DS[A+1], DS[A]} = D0[95:0]; tri-dword write.", @"", ISA_Enc.DS, 222, 0, 0xDB780000, 0x0003),
new InstInfo(0178, "ds_write_src2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[B]; write Dword.", @"", ISA_Enc.DS2, 140, 0, 0xDA300000, 0x0003),
new InstInfo(0179, "ds_write_src2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[B]; write Qword.", @"", ISA_Enc.DS2, 204, 0, 0xDB300000, 0x0003),
new InstInfo(0180, "ds_write2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[ADDR+offset0*4] = D0; DS[ADDR+offset1*4] = D1; write 2 Dwords.", @"", ISA_Enc.DS2, 14, 0, 0xD8380000, 0x0003),
new InstInfo(0181, "ds_write2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[ADDR+offset0*8] = D0; DS[ADDR+offset1*8] = D1; write 2 Dwords.", @"", ISA_Enc.DS2, 78, 0, 0xD9380000, 0x0003),
new InstInfo(0182, "ds_write2st64_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[ADDR+offset0*4*64] = D0; DS[ADDR+offset1*4*64] = D1; write 2 Dwords.", @"", ISA_Enc.DS2, 15, 0, 0xD83C0000, 0x0003),
new InstInfo(0183, "ds_write2st64_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[ADDR+offset0*8*64] = D0; DS[ADDR+offset1*8*64] = D1; write 2 Dwords.", @"", ISA_Enc.DS2, 79, 0, 0xD93C0000, 0x0003),
new InstInfo(0184, "ds_wrxchg_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write exchange. Offset = {offset1,offset0}. A = ADDR+offset. D=DS[Addr]. DS[Addr]=D0.", @"", ISA_Enc.DS, 45, 0, 0xD8B40000, 0x0003),
new InstInfo(0185, "ds_wrxchg_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write exchange.", @"", ISA_Enc.DS, 109, 0, 0xD9B40000, 0x0003),
new InstInfo(0186, "ds_wrxchg2_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write exchange 2 separate Dwords.", @"", ISA_Enc.DS2, 46, 0, 0xD8B80000, 0x0003),
new InstInfo(0187, "ds_wrxchg2_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write exchange relative.", @"", ISA_Enc.DS2, 110, 0, 0xD9B80000, 0x0003),
new InstInfo(0188, "ds_wrxchg2st64_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write exchange 2 Dwords, stride 64.", @"", ISA_Enc.DS2, 47, 0, 0xD8BC0000, 0x0003),
new InstInfo(0189, "ds_wrxchg2st64_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Write echange 2 Dwords.", @"", ISA_Enc.DS2, 111, 0, 0xD9BC0000, 0x0003),
new InstInfo(0190, "ds_xor_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"DS[A] = DS[A] ^ D0; Dword XOR.", @"", ISA_Enc.DS, 11, 0, 0xD82C0000, 0x0003),
new InstInfo(0191, "ds_xor_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword XOR.", @"", ISA_Enc.DS, 75, 0, 0xD92C0000, 0x0003),
new InstInfo(0192, "ds_xor_rtn_b32", "v4b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword XOR.", @"", ISA_Enc.DS, 43, 0, 0xD8AC0000, 0x0003),
new InstInfo(0193, "ds_xor_rtn_b64", "v8b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword XOR.", @"", ISA_Enc.DS, 107, 0, 0xD9AC0000, 0x0003),
new InstInfo(0194, "ds_xor_src2_b32", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"B = A + 4*(offset1[7] ? {A[31],A[31:17]} : {offset1[6],offset1[6:0],offset0}). DS[A] = DS[A] ^ DS[B]; Dword XOR.", @"", ISA_Enc.DS2, 139, 0, 0xDA2C0000, 0x0003),
new InstInfo(0195, "ds_xor_src2_b64", "none", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 4, 7, @"Dword XOR.", @"", ISA_Enc.DS2, 203, 0, 0xDB2C0000, 0x0003),

new InstInfo(0196, "flat_atomic_add", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst += src. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 50, 0, 0xDCC80000, 0x0003),
new InstInfo(0197, "flat_atomic_add_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst += src. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 82, 0, 0xDD480000, 0x0003),
new InstInfo(0198, "flat_atomic_and", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst &= src. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 57, 0, 0xDCE40000, 0x0003),
new InstInfo(0199, "flat_atomic_and_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst &= src. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 89, 0, 0xDD640000, 0x0003),
new InstInfo(0200, "flat_atomic_cmpswap", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst = (dst==cmp) ? src : dst. Returns previous value if rtn==1.src comes from the first data-VGPR, cmp from the second.", @"", ISA_Enc.FLAT, 49, 0, 0xDCC40000, 0x0003),
new InstInfo(0201, "flat_atomic_cmpswap_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst = (dst==cmp) ? src : dst. Returns previous value if rtn==1. src comes from the first two data-VGPRs, cmp from the second two.", @"", ISA_Enc.FLAT, 81, 0, 0xDD440000, 0x0003),
new InstInfo(0202, "flat_atomic_dec", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst = ((dst==0 || (dst > src)) ? src : dst-1 (unsigned comparison). Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 61, 0, 0xDCF40000, 0x0003),
new InstInfo(0203, "flat_atomic_dec_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst = ((dst==0 || (dst > src)) ? src : dst - 1. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 93, 0, 0xDD740000, 0x0003),
new InstInfo(0204, "flat_atomic_fcmpswap", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b , dst = (dst == cmp) ? src : dst, returns previous value if rtn==1. Floating point compare-swap handles NaN/INF/denorm. src comes from the first data-VGPR; cmp from the second.", @"", ISA_Enc.FLAT, 62, 0, 0xDCF80000, 0x0003),
new InstInfo(0205, "flat_atomic_fcmpswap_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b , dst = (dst == cmp) ? src : dst, returns previous value if rtn==1. Double compare swap (handles NaN/INF/denorm). src comes from the first two data-VGPRs, cmp from the second two.", @"", ISA_Enc.FLAT, 94, 0, 0xDD780000, 0x0003),
new InstInfo(0206, "flat_atomic_fmax", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b , dst = (src > dst) ? src : dst, returns previous value if rtn==1. Floating point compare handles NaN/INF/denorm.", @"", ISA_Enc.FLAT, 64, 0, 0xDD000000, 0x0003),
new InstInfo(0207, "flat_atomic_fmax_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b , dst = (src > dst) ? src : dst, returns previous value if rtn==1. Double, handles NaN/INF/denorm.", @"", ISA_Enc.FLAT, 96, 0, 0xDD800000, 0x0003),
new InstInfo(0208, "flat_atomic_fmin", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b , dst = (src < dst) ? src : dst. Returns previous value if rtn==1. float, handles NaN/INF/denorm.", @"", ISA_Enc.FLAT, 63, 0, 0xDCFC0000, 0x0003),
new InstInfo(0209, "flat_atomic_fmin_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b , dst = (src < dst) ? src : dst, returns previous value if rtn==1. Double, handles NaN/INF/denorm.", @"", ISA_Enc.FLAT, 95, 0, 0xDD7C0000, 0x0003),
new InstInfo(0210, "flat_atomic_inc", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst = (dst >= src) ? 0 : dst+1 (unsigned comparison). Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 60, 0, 0xDCF00000, 0x0003),
new InstInfo(0211, "flat_atomic_inc_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst = (dst >= src) ? 0 : dst+1. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 92, 0, 0xDD700000, 0x0003),
new InstInfo(0212, "flat_atomic_or", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst |= src. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 58, 0, 0xDCE80000, 0x0003),
new InstInfo(0213, "flat_atomic_or_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst |= src. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 90, 0, 0xDD680000, 0x0003),
new InstInfo(0214, "flat_atomic_smax", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst = (src > dst) ? src : dst (signed comparison). Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 55, 0, 0xDCDC0000, 0x0003),
new InstInfo(0215, "flat_atomic_smax_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst = (src > dst) ? src : dst (signed comparison). Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 87, 0, 0xDD5C0000, 0x0003),
new InstInfo(0216, "flat_atomic_smin", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst = (src < dst) ? src : dst (signed comparison). Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 53, 0, 0xDCD40000, 0x0003),
new InstInfo(0217, "flat_atomic_smin_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst = (src < dst) ? src : dst (signed comparison). Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 85, 0, 0xDD540000, 0x0003),
new InstInfo(0218, "flat_atomic_sub", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst -= src. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 51, 0, 0xDCCC0000, 0x0003),
new InstInfo(0219, "flat_atomic_sub_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst -= src. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 83, 0, 0xDD4C0000, 0x0003),
new InstInfo(0220, "flat_atomic_swap", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b. dst=src, returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 48, 0, 0xDCC00000, 0x0003),
new InstInfo(0221, "flat_atomic_swap_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b. dst=src, returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 80, 0, 0xDD400000, 0x0003),
new InstInfo(0222, "flat_atomic_umax", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst = (src > dst) ? src : dst (unsigned comparison). Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 56, 0, 0xDCE00000, 0x0003),
new InstInfo(0223, "flat_atomic_umax_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst = (src > dst) ? src : dst (unsigned comparison). Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 88, 0, 0xDD600000, 0x0003),
new InstInfo(0224, "flat_atomic_umin", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst = (src < dst) ? src : dst (unsigned comparison). Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 54, 0, 0xDCD80000, 0x0003),
new InstInfo(0225, "flat_atomic_umin_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst = (src < dst) ? src : dst (unsigned comparison). Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 86, 0, 0xDD580000, 0x0003),
new InstInfo(0226, "flat_atomic_xor", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 32b, dst ^= src. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 59, 0, 0xDCEC0000, 0x0003),
new InstInfo(0227, "flat_atomic_xor_x2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"ATOMIC - 64b, dst ^= src. Returns previous value if rtn==1.", @"", ISA_Enc.FLAT, 91, 0, 0xDD6C0000, 0x0003),
new InstInfo(0228, "flat_load_dword", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"LOAD - Flat load Dword.", @"", ISA_Enc.FLAT, 12, 0, 0xDC300000, 0x0003),
new InstInfo(0229, "flat_load_dwordx2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"LOAD - Flat load 2 Dwords.", @"", ISA_Enc.FLAT, 13, 0, 0xDC340000, 0x0003),
new InstInfo(0230, "flat_load_dwordx3", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"LOAD - Flat load 3 Dwords.", @"", ISA_Enc.FLAT, 15, 0, 0xDC3C0000, 0x0003),
new InstInfo(0231, "flat_load_dwordx4", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"LOAD - Flat load 4 Dwords.", @"", ISA_Enc.FLAT, 14, 0, 0xDC380000, 0x0003),
new InstInfo(0232, "flat_load_sbyte", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"LOAD - Flat load signed byte. Sign extend to VGPR destination.", @"", ISA_Enc.FLAT, 9, 0, 0xDC240000, 0x0003),
new InstInfo(0233, "flat_load_sshort", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"LOAD - Flat load signed short. Sign extend to VGPR destination.", @"", ISA_Enc.FLAT, 11, 0, 0xDC2C0000, 0x0003),
new InstInfo(0234, "flat_load_ubyte", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"LOAD - Flat load unsigned byte. Zero extend to VGPR destination.", @"", ISA_Enc.FLAT, 8, 0, 0xDC200000, 0x0003),
new InstInfo(0235, "flat_load_ushort", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"LOAD - Flat load unsigned short. Zero extebd to VGPR destination.", @"", ISA_Enc.FLAT, 10, 0, 0xDC280000, 0x0003),
new InstInfo(0236, "flat_store_byte", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"STORE - Flat store byte.", @"", ISA_Enc.FLAT, 24, 0, 0xDC600000, 0x0003),
new InstInfo(0237, "flat_store_dword", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"STORE - Flat store Dword.", @"", ISA_Enc.FLAT, 28, 0, 0xDC700000, 0x0003),
new InstInfo(0238, "flat_store_dwordx2", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"STORE - Flat store 2 Dwords.", @"", ISA_Enc.FLAT, 29, 0, 0xDC740000, 0x0003),
new InstInfo(0239, "flat_store_dwordx3", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"STORE - Flat store 3 Dwords.", @"", ISA_Enc.FLAT, 31, 0, 0xDC7C0000, 0x0003),
new InstInfo(0240, "flat_store_dwordx4", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"STORE - Flat store 4 Dwords.", @"", ISA_Enc.FLAT, 30, 0, 0xDC780000, 0x0003),
new InstInfo(0241, "flat_store_short", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 3, 6, @"STORE - Flat store short.", @"", ISA_Enc.FLAT, 26, 0, 0xDC680000, 0x0003),

new InstInfo(0242, "image_atomic_add", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst += src. Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 17, 0, 0xF0440000, 0x0003),
new InstInfo(0243, "image_atomic_and", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst &= src. Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 24, 0, 0xF0600000, 0x0003),
new InstInfo(0244, "image_atomic_cmpswap", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst = (dst==cmp) ? src : dst. Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 16, 0, 0xF0400000, 0x0003),
new InstInfo(0245, "image_atomic_dec", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst = ((dst==0 || (dst > src)) ? src : dst-1. Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 28, 0, 0xF0700000, 0x0003),
new InstInfo(0246, "image_atomic_fcmpswap", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst = (dst == cmp) ? src : dst, returns previous value of dst if glc==1 - double and float atomic compare swap. Obeys floating point compare rules for special values.", @"", ISA_Enc.MIMG, 29, 0, 0xF0740000, 0x0003),
new InstInfo(0247, "image_atomic_fmax", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst = (src > dst) ? src : dst, returns previous value of dst if glc==1 - double and float atomic min (handles NaN/INF/denorm).", @"", ISA_Enc.MIMG, 31, 0, 0xF07C0000, 0x0003),
new InstInfo(0248, "image_atomic_fmin", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst = (src < dst) ? src : dst, returns previous value of dst if glc==1 - double and float atomic min (handles NaN/INF/denorm).", @"", ISA_Enc.MIMG, 30, 0, 0xF0780000, 0x0003),
new InstInfo(0249, "image_atomic_inc", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst = (dst >= src) ? 0 : dst+1. Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 27, 0, 0xF06C0000, 0x0003),
new InstInfo(0250, "image_atomic_or", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst |= src. Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 25, 0, 0xF0640000, 0x0003),
new InstInfo(0251, "image_atomic_smax", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst = (src > dst) ? src : dst (signed). Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 22, 0, 0xF0580000, 0x0003),
new InstInfo(0252, "image_atomic_smin", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst = (src < dst) ? src : dst (signed). Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 20, 0, 0xF0500000, 0x0003),
new InstInfo(0253, "image_atomic_sub", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst -= src. Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 18, 0, 0xF0480000, 0x0003),
new InstInfo(0254, "image_atomic_swap", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst=src, returns previous value if glc==1.", @"", ISA_Enc.MIMG, 15, 0, 0xF03C0000, 0x0003),
new InstInfo(0255, "image_atomic_umax", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst = (src > dst) ? src : dst (unsigned). Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 23, 0, 0xF05C0000, 0x0003),
new InstInfo(0256, "image_atomic_umin", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst = (src < dst) ? src : dst (unsigned). Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 21, 0, 0xF0540000, 0x0003),
new InstInfo(0257, "image_atomic_xor", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"dst ^= src. Returns previous value if glc==1.", @"", ISA_Enc.MIMG, 26, 0, 0xF0680000, 0x0003),
new InstInfo(0258, "image_gather4", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2).", @"", ISA_Enc.MIMG, 64, 0, 0xF1000000, 0x0003),
new InstInfo(0259, "image_gather4_b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) with user bias.", @"", ISA_Enc.MIMG, 67, 0, 0xF10C0000, 0x0003),
new InstInfo(0260, "image_gather4_b_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) with user bias and clamp.", @"", ISA_Enc.MIMG, 68, 0, 0xF1100000, 0x0003),
new InstInfo(0261, "image_gather4_b_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_B_CL, with user offsets.", @"", ISA_Enc.MIMG, 86, 0, 0xF1580000, 0x0003),
new InstInfo(0262, "image_gather4_b_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_B, with user offsets.", @"", ISA_Enc.MIMG, 85, 0, 0xF1540000, 0x0003),
new InstInfo(0263, "image_gather4_c", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) with PCF.", @"", ISA_Enc.MIMG, 70, 0, 0xF1180000, 0x0003),
new InstInfo(0264, "image_gather4_c_b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) with user bias and PCF.", @"", ISA_Enc.MIMG, 77, 0, 0xF1340000, 0x0003),
new InstInfo(0265, "image_gather4_c_b_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) with user bias, clamp and PCF.", @"", ISA_Enc.MIMG, 78, 0, 0xF1380000, 0x0003),
new InstInfo(0266, "image_gather4_c_b_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_B_CL, with user offsets.", @"", ISA_Enc.MIMG, 94, 0, 0xF1780000, 0x0003),
new InstInfo(0267, "image_gather4_c_b_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_B, with user offsets.", @"", ISA_Enc.MIMG, 93, 0, 0xF1740000, 0x0003),
new InstInfo(0268, "image_gather4_c_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) with user LOD clamp and PCF.", @"", ISA_Enc.MIMG, 71, 0, 0xF11C0000, 0x0003),
new InstInfo(0269, "image_gather4_c_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_C_CL, with user offsets.", @"", ISA_Enc.MIMG, 89, 0, 0xF1640000, 0x0003),
new InstInfo(0270, "image_gather4_c_l", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) with user LOD and PCF.", @"", ISA_Enc.MIMG, 76, 0, 0xF1300000, 0x0003),
new InstInfo(0271, "image_gather4_c_l_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_C_L, with user offsets.", @"", ISA_Enc.MIMG, 92, 0, 0xF1700000, 0x0003),
new InstInfo(0272, "image_gather4_c_lz", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) at level 0, with PCF.", @"", ISA_Enc.MIMG, 79, 0, 0xF13C0000, 0x0003),
new InstInfo(0273, "image_gather4_c_lz_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_C_LZ, with user offsets.", @"", ISA_Enc.MIMG, 95, 0, 0xF17C0000, 0x0003),
new InstInfo(0274, "image_gather4_c_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_C, with user offsets.", @"", ISA_Enc.MIMG, 88, 0, 0xF1600000, 0x0003),
new InstInfo(0275, "image_gather4_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) with user LOD clamp.", @"", ISA_Enc.MIMG, 65, 0, 0xF1040000, 0x0003),
new InstInfo(0276, "image_gather4_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_CL, with user offsets.", @"", ISA_Enc.MIMG, 81, 0, 0xF1440000, 0x0003),
new InstInfo(0277, "image_gather4_l", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) with user LOD.", @"", ISA_Enc.MIMG, 66, 0, 0xF1080000, 0x0003),
new InstInfo(0278, "image_gather4_l_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_L, with user offsets.", @"", ISA_Enc.MIMG, 84, 0, 0xF1500000, 0x0003),
new InstInfo(0279, "image_gather4_lz", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"gather 4 single component elements (2x2) at level 0.", @"", ISA_Enc.MIMG, 69, 0, 0xF1140000, 0x0003),
new InstInfo(0280, "image_gather4_lz_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4_LZ, with user offsets.", @"", ISA_Enc.MIMG, 87, 0, 0xF15C0000, 0x0003),
new InstInfo(0281, "image_gather4_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"GATHER4, with user offsets.", @"", ISA_Enc.MIMG, 80, 0, 0xF1400000, 0x0003),
new InstInfo(0282, "image_get_lod", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Return calculated LOD.", @"", ISA_Enc.MIMG, 96, 0, 0xF1800000, 0x0003),
new InstInfo(0283, "image_get_resinfo", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"return resource info. No sampler.", @"", ISA_Enc.MIMG, 14, 0, 0xF0380000, 0x0003),
new InstInfo(0284, "image_load", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Image memory load with format conversion specified in T#. No sampler.", @"", ISA_Enc.MIMG, 0, 0, 0xF0000000, 0x0003),
new InstInfo(0285, "image_load_mip", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Image memory load with user-supplied mip level. No sampler.", @"", ISA_Enc.MIMG, 1, 0, 0xF0040000, 0x0003),
new InstInfo(0286, "image_load_mip_pck", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Image memory load with user-supplied mip level, no format conversion. No sampler.", @"", ISA_Enc.MIMG, 4, 0, 0xF0100000, 0x0003),
new InstInfo(0287, "image_load_mip_pck_sgn", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Image memory load with user-supplied mip level, no format conversion and with sign extension. No sampler.", @"", ISA_Enc.MIMG, 5, 0, 0xF0140000, 0x0003),
new InstInfo(0288, "image_load_pck", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Image memory load with no format conversion. No sampler.", @"", ISA_Enc.MIMG, 2, 0, 0xF0080000, 0x0003),
new InstInfo(0289, "image_load_pck_sgn", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Image memory load with no format conversion and sign extension. No sampler.", @"", ISA_Enc.MIMG, 3, 0, 0xF00C0000, 0x0003),
new InstInfo(0290, "image_sample", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map.", @"", ISA_Enc.MIMG, 32, 0, 0xF0800000, 0x0003),
new InstInfo(0291, "image_sample_b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, with lod bias.", @"", ISA_Enc.MIMG, 37, 0, 0xF0940000, 0x0003),
new InstInfo(0292, "image_sample_b_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, with LOD clamp specified in shader, with lod bias.", @"", ISA_Enc.MIMG, 38, 0, 0xF0980000, 0x0003),
new InstInfo(0293, "image_sample_b_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_O, with LOD clamp specified in shader, with lod bias.", @"", ISA_Enc.MIMG, 54, 0, 0xF0D80000, 0x0003),
new InstInfo(0294, "image_sample_b_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_O, with lod bias.", @"", ISA_Enc.MIMG, 53, 0, 0xF0D40000, 0x0003),
new InstInfo(0295, "image_sample_c", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, with PCF.", @"", ISA_Enc.MIMG, 40, 0, 0xF0A00000, 0x0003),
new InstInfo(0296, "image_sample_c_b", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C, with lod bias.", @"", ISA_Enc.MIMG, 45, 0, 0xF0B40000, 0x0003),
new InstInfo(0297, "image_sample_c_b_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C, with LOD clamp specified in shader, with lod bias.", @"", ISA_Enc.MIMG, 46, 0, 0xF0B80000, 0x0003),
new InstInfo(0298, "image_sample_c_b_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C_O, with LOD clamp specified in shader, with lod bias.", @"", ISA_Enc.MIMG, 62, 0, 0xF0F80000, 0x0003),
new InstInfo(0299, "image_sample_c_b_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C_O, with lod bias.", @"", ISA_Enc.MIMG, 61, 0, 0xF0F40000, 0x0003),
new InstInfo(0300, "image_sample_c_cd", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C, with user derivatives (LOD per quad).", @"", ISA_Enc.MIMG, 106, 0, 0xF1A80000, 0x0003),
new InstInfo(0301, "image_sample_c_cd_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C, with LOD clamp specified in shader, with user derivatives (LOD per quad).", @"", ISA_Enc.MIMG, 107, 0, 0xF1AC0000, 0x0003),
new InstInfo(0302, "image_sample_c_cd_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C_O, with LOD clamp specified in shader, with user derivatives (LOD per quad).", @"", ISA_Enc.MIMG, 111, 0, 0xF1BC0000, 0x0003),
new InstInfo(0303, "image_sample_c_cd_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C_O, with user derivatives (LOD per quad).", @"", ISA_Enc.MIMG, 110, 0, 0xF1B80000, 0x0003),
new InstInfo(0304, "image_sample_c_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C, with LOD clamp specified in shader.", @"", ISA_Enc.MIMG, 41, 0, 0xF0A40000, 0x0003),
new InstInfo(0305, "image_sample_c_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C_O, with LOD clamp specified in shader.", @"", ISA_Enc.MIMG, 57, 0, 0xF0E40000, 0x0003),
new InstInfo(0306, "image_sample_c_d", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C, with user derivatives.", @"", ISA_Enc.MIMG, 42, 0, 0xF0A80000, 0x0003),
new InstInfo(0307, "image_sample_c_d_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C, with LOD clamp specified in shader, with user derivatives.", @"", ISA_Enc.MIMG, 43, 0, 0xF0AC0000, 0x0003),
new InstInfo(0308, "image_sample_c_d_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C_O, with LOD clamp specified in shader, with user derivatives.", @"", ISA_Enc.MIMG, 59, 0, 0xF0EC0000, 0x0003),
new InstInfo(0309, "image_sample_c_d_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C_O, with user derivatives.", @"", ISA_Enc.MIMG, 58, 0, 0xF0E80000, 0x0003),
new InstInfo(0310, "image_sample_c_l", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C, with user LOD.", @"", ISA_Enc.MIMG, 44, 0, 0xF0B00000, 0x0003),
new InstInfo(0311, "image_sample_c_l_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C_O, with user LOD.", @"", ISA_Enc.MIMG, 60, 0, 0xF0F00000, 0x0003),
new InstInfo(0312, "image_sample_c_lz", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C, from level 0.", @"", ISA_Enc.MIMG, 47, 0, 0xF0BC0000, 0x0003),
new InstInfo(0313, "image_sample_c_lz_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C_O, from level 0.", @"", ISA_Enc.MIMG, 63, 0, 0xF0FC0000, 0x0003),
new InstInfo(0314, "image_sample_c_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_C with user specified offsets.", @"", ISA_Enc.MIMG, 56, 0, 0xF0E00000, 0x0003),
new InstInfo(0315, "image_sample_cd", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, with user derivatives (LOD per quad)", @"", ISA_Enc.MIMG, 104, 0, 0xF1A00000, 0x0003),
new InstInfo(0316, "image_sample_cd_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, with LOD clamp specified in shader, with user derivatives (LOD per quad).", @"", ISA_Enc.MIMG, 105, 0, 0xF1A40000, 0x0003),
new InstInfo(0317, "image_sample_cd_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_O, with LOD clamp specified in shader, with user derivatives (LOD per quad).", @"", ISA_Enc.MIMG, 109, 0, 0xF1B40000, 0x0003),
new InstInfo(0318, "image_sample_cd_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_O, with user derivatives (LOD per quad).", @"", ISA_Enc.MIMG, 108, 0, 0xF1B00000, 0x0003),
new InstInfo(0319, "image_sample_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, with LOD clamp specified in shader.", @"", ISA_Enc.MIMG, 33, 0, 0xF0840000, 0x0003),
new InstInfo(0320, "image_sample_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_O with LOD clamp specified in shader.", @"", ISA_Enc.MIMG, 49, 0, 0xF0C40000, 0x0003),
new InstInfo(0321, "image_sample_d", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, with user derivatives.", @"", ISA_Enc.MIMG, 34, 0, 0xF0880000, 0x0003),
new InstInfo(0322, "image_sample_d_cl", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, with LOD clamp specified in shader, with user derivatives.", @"", ISA_Enc.MIMG, 35, 0, 0xF08C0000, 0x0003),
new InstInfo(0323, "image_sample_d_cl_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_O, with LOD clamp specified in shader, with user derivatives.", @"", ISA_Enc.MIMG, 51, 0, 0xF0CC0000, 0x0003),
new InstInfo(0324, "image_sample_d_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_O, with user derivatives.", @"", ISA_Enc.MIMG, 50, 0, 0xF0C80000, 0x0003),
new InstInfo(0325, "image_sample_l", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, with user LOD.", @"", ISA_Enc.MIMG, 36, 0, 0xF0900000, 0x0003),
new InstInfo(0326, "image_sample_l_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_O, with user LOD.", @"", ISA_Enc.MIMG, 52, 0, 0xF0D00000, 0x0003),
new InstInfo(0327, "image_sample_lz", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, from level 0.", @"", ISA_Enc.MIMG, 39, 0, 0xF09C0000, 0x0003),
new InstInfo(0328, "image_sample_lz_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"SAMPLE_O, from level 0.", @"", ISA_Enc.MIMG, 55, 0, 0xF0DC0000, 0x0003),
new InstInfo(0329, "image_sample_o", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"sample texture map, with user offsets.", @"", ISA_Enc.MIMG, 48, 0, 0xF0C00000, 0x0003),
new InstInfo(0330, "image_store", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Image memory store with formatconversion specified in T#. No sampler.", @"", ISA_Enc.MIMG, 8, 0, 0xF0200000, 0x0003),
new InstInfo(0331, "image_store_mip", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Image memory store with format conversion specified in T# to user specified mip level. No sampler.", @"", ISA_Enc.MIMG, 9, 0, 0xF0240000, 0x0003),
new InstInfo(0332, "image_store_mip_pck", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Image memory store of packed data without format conversion to user-supplied mip level. No sampler.", @"", ISA_Enc.MIMG, 11, 0, 0xF02C0000, 0x0003),
new InstInfo(0333, "image_store_pck", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", "to-do", 0, 0, @"Image memory store of packed data without format conversion. No sampler.", @"", ISA_Enc.MIMG, 10, 0, 0xF0280000, 0x0003),
...
new InstInfo(1140, "v_readlane_b32", "s4b", "v4b", "v1u", "none", "none", "none", "none", 3, 3, @"Copy one VGPR value to a SGPR. Dst = SGPR-dest, Src0 = Source Data (VGPR# or M0(lds-direct)), Src1 = Lane Select (SGPR or M0). Ignores exec mask. A lane corresponds to one thread in a wavefront.  ", @"", ISA_Enc.VOP2, 1, 0, 0x02000000, 0x0001),
